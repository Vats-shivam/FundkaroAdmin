    ...
    return (
        <div>
          ...
          <div className='flex flex-wrap justify-center pt-8'> 
            {items.map((item) => {
                return (<div onClick={SelectCategory} className='p-4 mb-4 ml-2 mr-2 rounded-md w-56 shadow-dashboardshadow cursor-pointer'><img src={item.img} className='h-12 w-12 pr-2 inline-block'></img>{item.label}</div>)
            })}
          </div>
        </div>
      )      
