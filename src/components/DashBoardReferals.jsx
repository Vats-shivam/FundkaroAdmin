...
function DashboardReferals() {
    ...
    const ReferalLink = 'http://'+window.location.host+'/user/register/?ref='+currentuser.refferal_code
    ...
    return (<div className="pb-10">
        ...
        <div className="ml-24 pr-4 max-sm:ml-2 max-sm:w-auto max-sm:pl-4 max-lg:ml-20 max-lg:pl-44 pl-60 pb-8 pt-8 -mt-44 max-sm:-mt-12 w-[88%] max-lg:w-[80%] bg-[#4169E1] text-white rounded-br-[50px] rounded-tr-[50px] rounded-tl-[10px] rounded-bl-[500px] max-lg:rounded-bl-[50px]">
            ...
            <div className="leading-[28px] inline-block w-full text-[14px] font-semibold mt-4 p-2 rounded bg-white text-black">
                <div className="float-left ms-2">{ReferalLink}</div>
                <div className="float-right cursor-pointer w-fit hover:bg-[#EAEAEA] pl-2 border text-[14px] font-semibold rounded-[5px] border-black leading-[16.8px] p-1" onClick={CopyLink}>Copy Link <img className="inline-block pl-1 pr-1" src={Copy}></img></div>
            </div>
